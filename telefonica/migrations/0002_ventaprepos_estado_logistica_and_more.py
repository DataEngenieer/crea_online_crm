# Generated by Django 5.2.1 on 2025-07-16 02:26
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunSQL(
            """
            CREATE TABLE IF NOT EXISTS telefonica_ventaportabilidad (
            ...
            CREATE TABLE IF NOT EXISTS telefonica_ventaprepos (
                id bigint NOT NULL PRIMARY KEY,
                numero varchar(100) NOT NULL,
                tipo_cliente varchar(20) NOT NULL,
                tipo_documento varchar(10) NOT NULL,
            ...
            CREATE TABLE IF NOT EXISTS telefonica_ventaupgrade (
                id bigint NOT NULL PRIMARY KEY,
                numero varchar(100) NOT NULL,
                tipo_cliente varchar(20) NOT NULL,
                tipo_documento varchar(10) NOT NULL,
            ...
            """,
            """
            -- No reverse SQL needed as we're just ensuring tables exist
            """
        ),
        migrations.RunSQL(
            """
            DO $$
            BEGIN
                -- Verificar si la columna estado_logistica existe en ventaprepos
                ...
                -- Verificar si la columna estado_venta existe en ventaprepos
                ...
                -- Verificar si la columna estado_logistica existe en ventaupgrade
                ...
                -- Verificar si la columna estado_venta existe en ventaupgrade
        ...
        migrations.RunSQL(
            ...
            DO $$
            BEGIN
                -- Actualizar Estado_agendamiento en agendamiento si existe
                ...
                -- Actualizar estado_logistica en ventaportabilidad si existe
                ...
                -- Actualizar estado_venta en ventaportabilidad si existe
                ...
                -- Actualizar numero en ventaportabilidad si existe
                ...
                -- Actualizar numero en ventaprepos si existe
                ...
                -- Actualizar numero en ventaupgrade si existe
